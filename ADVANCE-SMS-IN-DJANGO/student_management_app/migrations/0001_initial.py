# Generated by Django 4.2.11 on 2024-04-15 13:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('Nursery', 'Nursery'), ('Primary', 'Primary'), ('Junior', 'Junior')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('parent_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subclasses', to='student_management_app.classes')),
            ],
        ),
        migrations.CreateModel(
            name='Subject',
            fields=[
                ...
                ('class_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subjects', to='student_management_app.classes')),
                ('staff_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('subclass_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subjects', to='student_management_app.subclasses')),
            ],
        ),
        migrations.CreateModel(
            name='Students',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_grade', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
